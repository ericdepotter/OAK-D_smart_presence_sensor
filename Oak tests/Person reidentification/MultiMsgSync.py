# rectified_right frames (ImgFrame), object detection (ImgDetections) and recognition (NNData)
...
class TwoStageHostSeqSync:
    def __init__(self):
        self.msgs = {}
    # name: rectified_right, detection, or recognition
    def add_msg(self, msg, name):
        ...
        elif name == "rectified_right": # rectified_right
            # Save rectified_right frame in the directory
            self.msgs[seq][name] = msg
            #print(f'Added frame seq {seq}')

        elif name == "depth": # depth
            # Save depth frame in the directory
            self.msgs[seq][name] = msg
            # print(f'Added depth seq {seq}')
    ...
    def get_msgs(self):
        ...
        for seq, msgs in self.msgs.items():
            ...
            # Check if we have both detections and rectified_right frame with this sequence number
            if "rectified_right" in msgs and "len" in msgs:
