...
# Source: https://docs.luxonis.com/projects/api/en/latest/samples/SpatialDetection/spatial_mobilenet/#rgb-mobilenetssd-with-spatial-data
    ...
    while True:
        ...
        if len(detections) != 0:
            ...
            for roiData in roiDatas:
                ...
                cv2.rectangle(depthFrameColor, (xmin, ymin), (xmax, ymax), (255, 255, 255), cv2.FONT_HERSHEY_SCRIPT_SIMPLEX)
